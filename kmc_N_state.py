...
class KMC:
    ...
    def execute_transition(self):
        if self.selected_site[1] == 0:
            if self.site[self.selected_site[0]] == 0:
                ...
                #print(r"0 \to 1 Transition")
            elif self.site[self.selected_site[0]] == 1:
                self.site[self.selected_site[0]] = 0
                #print(r"1 \to 0 Transition")
        elif self.selected_site[1] == 1:
            if self.site[self.selected_site[0]] == 0:
                self.site[self.selected_site[0]] = 2
                #print(r"0 \to 2 Transition")
            elif self.site[self.selected_site[0]] == 2:
                self.site[self.selected_site[0]] = 0
                #print(r"2 \to 0 Transition")
        elif self.selected_site[1] == 2:
            if self.site[self.selected_site[0]] == 1:
                self.site[self.selected_site[0]] = 2
                #print(r"1 \to 2 Transition")
            elif self.site[self.selected_site[0]] == 2:
                self.site[self.selected_site[0]] = 1
                #print(r"2 \to 1 Transition")
    ...
    def evolve(self):
        ...
        for self.mcs in range(self.num_steps):
            ...
            self.t += self.dt
            print("Simulation Step = ",self.mcs," of ",self.num_steps)
