...
def main():
    ...
    filename = 'Binary_Kinetic_Monte_Carlo.png'
    plt.savefig(filename)
    plt.close()
    email.email_me('alexjanhackett@gmail.com', 'Portumna1', 'alexjanhackett@gmail.com', 'Binary KMC Test', 'This is the long email based test of the binary kinetic Monte Carlo simulation', filename)
